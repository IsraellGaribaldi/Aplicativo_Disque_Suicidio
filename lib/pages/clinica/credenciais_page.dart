...
class CredenciaisPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String nomeExibido =
        clinica?.nome ?? profissional?.nome ?? 'Credenciais';
    ...
    final List<String> documentosAutonomo =
        (profissional?.credenciais != null &&
                profissional!.credenciais.isNotEmpty)
    ...
    final List<String> formacoesAutonomo = [
      if (profissional?.especialidade != null &&
          profissional!.especialidade.isNotEmpty)
